"""
Nuxt Blog - Backend API
Nuxt.js content blog with SSR, SEO, categories, and RSS feed
"""
...
app = FastAPI(
    title="Nuxt Blog",
    description="Nuxt.js content blog with SSR, SEO, categories, and RSS feed",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "Nuxt Blog"}
